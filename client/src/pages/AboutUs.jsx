    ...
    <>
      ...
      <main className='container'>
        ...
        <section className='row justify-content-center site-text-color'>
          ...
          <div className='col-md-4'>
            <div className='row justify-content-around'>
              <div className='col-1 d-flex align-items-center text-end num-donations'>1m+</div>
          ...
          <div className='col-md-4'>
            <div className='row justify-content-around'>
              <div className='col-1 d-flex align-items-center text-end rating'>#1</div>
        ...
        <section className='row justify-content-start'>
          <div className='col-md-2'><button className="btn site-text-color bg-white border rounded p-5" onClick={() => navigate('/login')}>Sign-in</button></div>
          <div className='col-md-2'><button className="btn site-bg-color text-white border rounded p-5" onClick={() => navigate('/signup')}>Sign-up</button></div>
        </section>
        ...
        <section className='row my-5 justify-content-between learn-more'>
          ...
          <div className="col-md-3"><img src={LearnMoreImage} className="w-100" alt="learn more" /><h2 className='text-start site-text-color'>Learn more...</h2></div>
          <div className="col-md-3"><img src={FaqsImage} className="w-100" alt="faqs" /><h2 className='text-start site-text-color'>Faqs</h2></div>
