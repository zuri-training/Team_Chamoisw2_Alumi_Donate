    ...
    <Header />
      <main className='w-100 mb-5'>
       ...
       <section className='row'>
        ...
        <div className='col-md-4 position-relative d-flex px-0 mx-0'>
          <img src={heroDonate} alt="hero-right" className='img-fluid position-absolute' style={{ width: "100%", height: "100%", zIndex:2 }} />
          <img src={heroDonateBg} alt="hero-right-bg" className='img-fluid position-absolute' style={{ width: "100%", height: "100%", zIndex:1 }} />
        </div>
       </section>
        <br />
        {/* Our mission and testimonials */}
        <section className='row our-mission align-items-center flex-column mt-3 py-3'>
          <h2 className='mt-3'>Our Mission</h2>
          <div className='row justify-content-around mt-5'>
            <div className="col-3 d-flex flex-column align-items-center"><span className='mission-number'>01</span><div className='mission-text'>To help institutions reach their project targets by connecting them to their Alumnis who would want to be a part of these projects.</div></div>
            <div className="col-3 d-flex flex-column align-items-center"><span className='mission-number'>02</span><div className='mission-text'>To ensure that 10,000 Nigerian students get scholarships through the fundings generated  from this platform.</div></div>
            <div className="col-3 d-flex flex-column align-items-center"><span className='mission-number'>03</span><div className='mission-text'>To help Alumnis,  make donations to their Alma-Mater Hassle-free, through verified source</div></div>
          </div>
          ...
          <div className='row testimonial justify-content-center mt-4'>
        ...
        <section className='row mt-5 make-a-difference justify-content-center align-items-center flex-column'>
          ...
          <div className="row justify-content-evenly">
            ...
            <div className='col-md-4'><img src={graduation} alt='graduation' /></div>
          </div>
          <br />
          ...
          <div className="row justify-content-evenly">
            ...
            <div className='col-md-4'><img src={map} alt='graduation' /></div>
          </div>
        </section>
      </main>  
      <Footer />
