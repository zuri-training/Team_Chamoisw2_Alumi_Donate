...
function Footer() {
  return (
    <styled.Container>
      <styled.Inspire>Share and inspire others</styled.Inspire>
      <styled.Socials>
      ...
      <styled.Charity>
        ...
        <styled.fundraiser>
          https://www.bowenuniversity.com/fundraiser/charity/98235
        </styled.fundraiser>
      </styled.Charity>
      ...
      <styled.socialsContainer>
        ...
        <styled.aboutUsText1>
          we are a platform that helps alumni give
        </styled.aboutUsText1>
        <styled.aboutUsText2>
          back to their Alma-mater. You can reach us on this platform.
        </styled.aboutUsText2>
